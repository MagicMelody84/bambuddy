export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'Apri l’interfaccia web del dispositivo',
      webInterfaceMixedContent: 'Impossibile incorporare — Bambuddy usa HTTPS e il dispositivo fornisce solo HTTP. Aprilo in una nuova scheda.',
      webInterfaceHint: 'Pagina vuota o non funzionante? Il dispositivo potrebbe bloccare l’incorporamento.',
      firmware: 'Firmware',
  ...
  // Campi bobina definiti dall'utente
  customFields: {
    title: 'Campi personalizzati',
    subtitle: 'Definisci campi tuoi e usali su ogni bobina',
    manage: 'Campi personalizzati',
    add: 'Aggiungi campo',
    edit: 'Modifica campo',
    name: 'Nome',
    namePlaceholder: 'es. Cliente, Lotto',
    key: 'Chiave',
    keyPlaceholder: 'es. cliente',
    keyHint: 'Identificatore per l’API e Spoolman. Ricavato dal nome; solo lettere latine, cifre e trattini bassi.',
    keyLocked: 'La chiave è fissa non appena il campo esiste.',
    type: 'Tipo',
    typeHint: 'Determina come si inserisce il valore su ogni bobina.',
    typeLocked: 'Il tipo è bloccato finché ci sono bobine con un valore per questo campo.',
    clear: 'Svuota',
    rangeMin: 'Min.',
    rangeMax: 'Max.',
    rangeMaxAria: '{{name}} massimo',
    types: {
      text: 'Testo',
      integer: 'Intero',
      integer_range: 'Intervallo di interi',
      float: 'Decimale',
      float_range: 'Intervallo decimale',
      datetime: 'Data e ora',
      boolean: 'Sì / No',
      choice: 'Elenco di scelte',
    },
    options: 'Opzioni',
    optionPlaceholder: 'Digita un’opzione e premi Invio',
    optionsRequired: 'Aggiungi almeno un’opzione',
    optionDuplicate: 'Questa opzione esiste già',
    nameRequired: 'Il nome del campo è obbligatorio',
    spools: 'Bobine',
    empty: 'Nessun campo personalizzato. Creane uno per aggiungere dati tuoi alle bobine.',
    noValue: 'Nessun valore',
    staleOption: '{{value}} (rimossa)',
    created: 'Campo creato',
    updated: 'Campo aggiornato',
    deleted: 'Campo eliminato',
    saveFailed: 'Salvataggio del campo non riuscito',
    deleteFailed: 'Eliminazione del campo non riuscita',
    confirmDelete: 'Eliminare "{{name}}"?',
    confirmDeleteMessage: 'Il campo sparirà da tutti i moduli bobina.',
    confirmDeleteMessageInUse: 'Il campo è usato su {{count}} bobina/e. Anche quei valori verranno eliminati.',
    editAria: 'Modifica {{name}}',
    deleteAria: 'Elimina {{name}}',
    removeOptionAria: 'Rimuovi {{option}}',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Bobine di filamento, cronologia d’uso, monitoraggio dei costi, posizioni di stoccaggio e campi personalizzati',
