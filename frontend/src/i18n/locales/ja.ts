export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'デバイスの Web インターフェースを開く',
      webInterfaceMixedContent: '埋め込めません — Bambuddy は HTTPS で動作していますが、デバイスは HTTP のみ提供します。新しいタブで開いてください。',
      webInterfaceHint: '空白または動作しませんか？デバイスが埋め込みをブロックしている可能性があります。',
      firmware: 'ファームウェア',
      lastSeen: '最終接続',
  ...
  locations: {
    ...
    edit: '場所を編集',
    name: '名前',
    hasTag: 'RFIDタグが割り当て済み',
    spools: 'スプール',
    sensors: 'センサー',
    empty: '保管場所がありません。最初の棚または引き出しを作成してください。',
    search: '保管場所を検索...',
    noSearchResults: '条件に一致する保管場所がありません。',
    manage: '保管場所',
    ...
    clearRfid: 'RFIDタグを消去',
    rfidCleared: 'RFIDタグを消去しました',
    tagClearFailed: 'タグを消去できませんでした',
  ...
  customFields: {
    title: 'カスタムフィールド',
    subtitle: '独自の項目を定義して、すべてのスプールで使用します',
    manage: 'カスタムフィールド',
    add: 'フィールドを追加',
    edit: 'フィールドを編集',
    name: '名前',
    namePlaceholder: '例: 顧客、ロット',
    key: 'キー',
    keyPlaceholder: '例: customer',
    keyHint: 'API と Spoolman 用の識別子。名前から自動入力されます。半角英数字とアンダースコアのみ。',
    keyLocked: 'フィールドを作成するとキーは変更できません。',
    type: '種類',
    typeHint: '各スプールでの値の入力方法を決めます。',
    typeLocked: 'この項目に値を持つスプールがある間、種類は変更できません。',
    clear: 'クリア',
    rangeMin: '最小',
    rangeMax: '最大',
    rangeMaxAria: '{{name}} の最大値',
    types: {
      text: 'テキスト',
      integer: '整数',
      integer_range: '整数の範囲',
    ...
    options: '選択肢',
    optionPlaceholder: '選択肢を入力して Enter',
    optionsRequired: '選択肢を1つ以上追加してください',
    optionDuplicate: 'その選択肢は既に存在します',
    nameRequired: 'フィールド名は必須です',
    spools: 'スプール',
    empty: 'カスタムフィールドがありません。作成するとスプールに独自のデータを追加できます。',
    noValue: '値なし',
    staleOption: '{{value}}（削除済み）',
    created: 'フィールドを作成しました',
    updated: 'フィールドを更新しました',
    deleted: 'フィールドを削除しました',
    saveFailed: 'フィールドの保存に失敗しました',
    deleteFailed: 'フィールドの削除に失敗しました',
    confirmDelete: '「{{name}}」を削除しますか？',
    confirmDeleteMessage: 'このフィールドはすべてのスプールフォームから消えます。',
    confirmDeleteMessageInUse: 'このフィールドは {{count}} 件のスプールで使用されています。それらの値も削除されます。',
    editAria: '{{name}} を編集',
    deleteAria: '{{name}} を削除',
    removeOptionAria: '{{option}} を削除',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'フィラメントスプール、使用履歴、コスト管理、保管場所、カスタムフィールド',
