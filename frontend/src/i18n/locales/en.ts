export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'Open the device’s web interface',
      webInterfaceMixedContent: 'Can’t embed this — Bambuddy is running over HTTPS and the device only serves plain HTTP. Open it in a new tab instead.',
      webInterfaceHint: 'Blank or not working? The device may be blocking embedding.',
      firmware: 'Firmware',
      lastSeen: 'Last seen',
  ...
  // User-defined spool fields (custom fields)
  customFields: {
    title: 'Custom Fields',
    subtitle: 'Define your own fields and use them on every spool',
    manage: 'Custom Fields',
    add: 'Add Field',
    edit: 'Edit Field',
    name: 'Name',
    namePlaceholder: 'e.g. Customer, Batch',
    key: 'Key',
    keyPlaceholder: 'e.g. customer',
    keyHint: 'Identifier for the API and Spoolman. Filled in from the name; latin letters, digits and underscores only.',
    keyLocked: 'The key is fixed once the field exists.',
    type: 'Type',
    typeHint: 'Decides how the value is entered on each spool.',
    typeLocked: 'The type is locked while spools hold a value for this field.',
    clear: 'Clear',
    rangeMin: 'Min',
    rangeMax: 'Max',
    ...
    options: 'Options',
    optionPlaceholder: 'Add an option and press Enter',
    optionsRequired: 'Add at least one option',
    optionDuplicate: 'That option already exists',
    nameRequired: 'Field name is required',
    spools: 'Spools',
    empty: 'No custom fields yet. Create one to add your own data to spools.',
    noValue: 'No value',
    staleOption: '{{value}} (removed)',
    ...
    confirmDelete: 'Delete "{{name}}"?',
    confirmDeleteMessage: 'The field will be removed from every spool form.',
    confirmDeleteMessageInUse: 'The field is used on {{count}} spool(s). Those values will be deleted too.',
    editAria: 'Edit {{name}}',
    deleteAria: 'Delete {{name}}',
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Filament spools, usage history, cost tracking, storage locations and custom fields',
