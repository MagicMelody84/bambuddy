export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'Abrir a interface web do dispositivo',
      webInterfaceMixedContent: 'Não é possível incorporar — o Bambuddy roda em HTTPS e o dispositivo serve apenas HTTP. Abra em uma nova aba.',
      webInterfaceHint: 'Em branco ou não funciona? O dispositivo pode estar bloqueando a incorporação.',
      firmware: 'Firmware',
  ...
  locations: {
    ...
    clearRfid: 'Limpar etiqueta RFID',
    rfidCleared: 'Etiqueta RFID limpa',
    tagClearFailed: 'Falha ao limpar a etiqueta',
  ...
  // Campos de bobina definidos pelo usuário
  customFields: {
    title: 'Campos personalizados',
    subtitle: 'Defina seus próprios campos e use-os em todas as bobinas',
    manage: 'Campos personalizados',
    add: 'Adicionar campo',
    edit: 'Editar campo',
    name: 'Nome',
    namePlaceholder: 'ex.: Cliente, Lote',
    key: 'Chave',
    keyPlaceholder: 'ex.: cliente',
    keyHint: 'Identificador para a API e o Spoolman. Preenchido a partir do nome; apenas letras latinas, dígitos e sublinhados.',
    keyLocked: 'A chave fica fixa assim que o campo existe.',
    type: 'Tipo',
    typeHint: 'Define como o valor é informado em cada bobina.',
    typeLocked: 'O tipo fica travado enquanto houver bobinas com valor neste campo.',
    clear: 'Limpar',
    rangeMin: 'Mín',
    rangeMax: 'Máx',
    rangeMaxAria: '{{name}} máximo',
    types: {
      text: 'Texto',
      integer: 'Inteiro',
    ...
    options: 'Opções',
    optionPlaceholder: 'Digite uma opção e pressione Enter',
    optionsRequired: 'Adicione pelo menos uma opção',
    optionDuplicate: 'Essa opção já existe',
    nameRequired: 'O nome do campo é obrigatório',
    spools: 'Bobinas',
    empty: 'Ainda não há campos personalizados. Crie um para adicionar seus próprios dados às bobinas.',
    noValue: 'Sem valor',
    staleOption: '{{value}} (removida)',
    created: 'Campo criado',
    updated: 'Campo atualizado',
    deleted: 'Campo excluído',
    saveFailed: 'Falha ao salvar o campo',
    deleteFailed: 'Falha ao excluir o campo',
    confirmDelete: 'Excluir "{{name}}"?',
    confirmDeleteMessage: 'O campo sumirá de todos os formulários de bobina.',
    confirmDeleteMessageInUse: 'O campo é usado em {{count}} bobina(s). Esses valores também serão excluídos.',
    editAria: 'Editar {{name}}',
    deleteAria: 'Excluir {{name}}',
    removeOptionAria: 'Remover {{option}}',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Bobinas de filamento, histórico de uso, controle de custos, locais de armazenamento e campos personalizados',
