export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      ipAddress: 'IP 位址',
      webInterface: '網頁介面',
      openWebInterface: '開啟裝置的網頁介面',
      webInterfaceMixedContent: '無法嵌入 — Bambuddy 執行於 HTTPS，而裝置僅提供純 HTTP。請在新分頁中開啟。',
      webInterfaceHint: '空白或無法使用？裝置可能封鎖了嵌入。',
      firmware: '韌體',
      lastSeen: '上次線上',
  ...
  customFields: {
    title: '自訂欄位',
    subtitle: '定義自己的欄位，並套用到每一捲線材',
    manage: '自訂欄位',
    add: '新增欄位',
    edit: '編輯欄位',
    name: '名稱',
    namePlaceholder: '例如：客戶、批次',
    key: '鍵名',
    keyPlaceholder: '例如 customer',
    keyHint: 'API 與 Spoolman 使用的識別碼。依名稱自動填入，僅限拉丁字母、數字與底線。',
    keyLocked: '欄位建立後鍵名不可變更。',
    type: '類型',
    typeHint: '決定該值在每捲線材上的輸入方式。',
    typeLocked: '當有線材填寫了此欄位時，類型無法變更。',
    clear: '清空',
    rangeMin: '最小',
    rangeMax: '最大',
    ...
    options: '選項',
    optionPlaceholder: '輸入選項後按 Enter',
    optionsRequired: '至少新增一個選項',
    optionDuplicate: '該選項已存在',
    nameRequired: '欄位名稱為必填',
    spools: '線材捲',
    empty: '尚無自訂欄位。建立一個即可為線材捲加入自己的資料。',
    noValue: '無值',
    staleOption: '{{value}}（已移除）',
    created: '已建立欄位',
    updated: '已更新欄位',
    deleted: '已刪除欄位',
    saveFailed: '儲存欄位失敗',
    deleteFailed: '刪除欄位失敗',
    confirmDelete: '刪除「{{name}}」？',
    confirmDeleteMessage: '此欄位將從所有線材表單中移除。',
    confirmDeleteMessageInUse: '此欄位已用於 {{count}} 捲線材，這些值也會一併刪除。',
    editAria: '編輯 {{name}}',
    deleteAria: '刪除 {{name}}',
  ...
  backup: {
    ...
    spoolInventory: '耗材庫存',
    spoolInventoryDescription: '耗材卷軸、使用紀錄、成本追蹤、存放位置與自訂欄位',
    printArchives: '列印檔案',
