export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      ipAddress: 'IP 地址',
      webInterface: '网页界面',
      openWebInterface: '打开设备的网页界面',
      webInterfaceMixedContent: '无法嵌入 — Bambuddy 运行在 HTTPS 上，而设备仅提供普通 HTTP。请在新标签页中打开。',
      webInterfaceHint: '空白或无法使用？设备可能阻止了嵌入。',
      firmware: '固件',
      lastSeen: '上次在线',
  ...
  customFields: {
    title: '自定义字段',
    subtitle: '定义自己的字段，并用于每一个料盘',
    manage: '自定义字段',
    add: '添加字段',
    edit: '编辑字段',
    name: '名称',
    namePlaceholder: '例如：客户、批次',
    key: '键名',
    keyPlaceholder: '例如 customer',
    keyHint: 'API 与 Spoolman 使用的标识符。根据名称自动填入，仅限拉丁字母、数字和下划线。',
    keyLocked: '字段创建后键名不可更改。',
    type: '类型',
    typeHint: '决定该值在每个料盘上的输入方式。',
    typeLocked: '当有料盘填写了该字段时，类型无法更改。',
    clear: '清空',
    rangeMin: '最小',
    rangeMax: '最大',
    rangeMaxAria: '{{name}} 最大值',
    types: {
      text: '文本',
      integer: '整数',
      integer_range: '整数区间',
    ...
    options: '选项',
    optionPlaceholder: '输入选项后按回车',
    optionsRequired: '至少添加一个选项',
    optionDuplicate: '该选项已存在',
    nameRequired: '字段名称为必填项',
    spools: '料盘',
    empty: '还没有自定义字段。创建一个即可为料盘添加自己的数据。',
    noValue: '无值',
    staleOption: '{{value}}（已删除）',
    created: '字段已创建',
    updated: '字段已更新',
    deleted: '字段已删除',
    saveFailed: '保存字段失败',
    deleteFailed: '删除字段失败',
    confirmDelete: '删除“{{name}}”？',
    confirmDeleteMessage: '该字段将从所有料盘表单中移除。',
    confirmDeleteMessageInUse: '该字段已用于 {{count}} 个料盘，这些值也会一并删除。',
    editAria: '编辑 {{name}}',
    deleteAria: '删除 {{name}}',
    removeOptionAria: '移除 {{option}}',
  },
  ...
  backup: {
    ...
    spoolInventory: '耗材库存',
    spoolInventoryDescription: '耗材卷轴、使用记录、成本追踪、存放位置和自定义字段',
    printArchives: '打印档案',
