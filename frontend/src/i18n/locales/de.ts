export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'Weboberfläche des Geräts öffnen',
      webInterfaceMixedContent: 'Kann nicht eingebettet werden — Bambuddy läuft über HTTPS, das Gerät liefert nur HTTP aus. Bitte in neuem Tab öffnen.',
      webInterfaceHint: 'Bleibt es leer oder funktioniert nichts? Das Gerät blockiert eventuell das Einbetten.',
      firmware: 'Firmware',
  ...
  locations: {
    ...
    name: 'Name',
    hasTag: 'RFID-Tag zugewiesen',
    spools: 'Spulen',
    sensors: 'Sensoren',
    empty: 'Noch keine Lagerorte. Erstellen Sie Ihr erstes Regal oder Ihre erste Schublade.',
    search: 'Lagerorte durchsuchen...',
    noSearchResults: 'Keine Lagerorte gefunden.',
    manage: 'Lagerorte',
  ...
  // Benutzerdefinierte Spulenfelder (Custom Fields)
  customFields: {
    title: 'Eigene Felder',
    subtitle: 'Eigene Felder definieren und an jeder Spule nutzen',
    manage: 'Eigene Felder',
    add: 'Feld hinzufügen',
    edit: 'Feld bearbeiten',
    name: 'Name',
    namePlaceholder: 'z. B. Kunde, Charge',
    key: 'Key',
    keyPlaceholder: 'z. B. kunde',
    keyHint: 'Bezeichner für API und Spoolman. Wird aus dem Namen übernommen; nur lateinische Buchstaben, Ziffern und Unterstriche.',
    keyLocked: 'Der Key steht fest, sobald das Feld existiert.',
    type: 'Typ',
    typeHint: 'Legt fest, wie der Wert an jeder Spule eingegeben wird.',
    typeLocked: 'Der Typ ist gesperrt, solange Spulen einen Wert für dieses Feld haben.',
    clear: 'Leeren',
    rangeMin: 'Min',
    rangeMax: 'Max',
    rangeMaxAria: '{{name}} Maximum',
    types: {
      text: 'Freitext',
      integer: 'Ganzzahl',
      integer_range: 'Ganzzahl-Bereich',
      float: 'Kommazahl',
      float_range: 'Kommazahl-Bereich',
    ...
    optionsRequired: 'Mindestens eine Option hinzufügen',
    optionDuplicate: 'Diese Option gibt es bereits',
    nameRequired: 'Feldname ist erforderlich',
    spools: 'Spulen',
    empty: 'Noch keine eigenen Felder. Lege eines an, um eigene Daten an Spulen zu hinterlegen.',
    noValue: 'Kein Wert',
    staleOption: '{{value}} (entfernt)',
    created: 'Feld erstellt',
    updated: 'Feld aktualisiert',
    deleted: 'Feld gelöscht',
    saveFailed: 'Feld konnte nicht gespeichert werden',
    deleteFailed: 'Feld konnte nicht gelöscht werden',
    confirmDelete: '„{{name}}" löschen?',
    confirmDeleteMessage: 'Das Feld verschwindet aus allen Spulenformularen.',
    confirmDeleteMessageInUse: 'Das Feld wird an {{count}} Spule(n) verwendet. Diese Werte werden mit gelöscht.',
    editAria: '{{name}} bearbeiten',
    deleteAria: '{{name}} löschen',
    removeOptionAria: '{{option}} entfernen',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Filamentspulen, Nutzungsverlauf, Kostenverfolgung, Lagerorte und eigene Felder',
