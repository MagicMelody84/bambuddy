export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'Abrir la interfaz web del dispositivo',
      webInterfaceMixedContent: 'No se puede incrustar — Bambuddy funciona sobre HTTPS y el dispositivo solo ofrece HTTP simple. Ábralo en una pestaña nueva.',
      webInterfaceHint: '¿En blanco o no funciona? Puede que el dispositivo bloquee la incrustación.',
      firmware: 'Firmware',
  ...
  locations: {
    ...
    tagClearFailed: 'No se pudo borrar la etiqueta',
  ...
  // Campos de bobina definidos por el usuario
  customFields: {
    title: 'Campos personalizados',
    subtitle: 'Define tus propios campos y úsalos en todas las bobinas',
    manage: 'Campos personalizados',
    add: 'Añadir campo',
    edit: 'Editar campo',
    name: 'Nombre',
    namePlaceholder: 'p. ej. Cliente, Lote',
    key: 'Clave',
    keyPlaceholder: 'p. ej. cliente',
    keyHint: 'Identificador para la API y Spoolman. Se rellena a partir del nombre; solo letras latinas, dígitos y guiones bajos.',
    keyLocked: 'La clave queda fija en cuanto el campo existe.',
    type: 'Tipo',
    typeHint: 'Determina cómo se introduce el valor en cada bobina.',
    typeLocked: 'El tipo está bloqueado mientras haya bobinas con un valor en este campo.',
    clear: 'Vaciar',
    rangeMin: 'Mín',
    rangeMax: 'Máx',
    ...
    types: {
      text: 'Texto',
      integer: 'Entero',
      integer_range: 'Intervalo de enteros',
      float: 'Decimal',
    ...
    options: 'Opciones',
    optionPlaceholder: 'Escribe una opción y pulsa Intro',
    optionsRequired: 'Añade al menos una opción',
    optionDuplicate: 'Esa opción ya existe',
    nameRequired: 'El nombre del campo es obligatorio',
    spools: 'Bobinas',
    empty: 'Todavía no hay campos personalizados. Crea uno para añadir tus propios datos a las bobinas.',
    noValue: 'Sin valor',
    staleOption: '{{value}} (eliminada)',
    created: 'Campo creado',
    updated: 'Campo actualizado',
    deleted: 'Campo eliminado',
    saveFailed: 'No se pudo guardar el campo',
    deleteFailed: 'No se pudo eliminar el campo',
    confirmDelete: '¿Eliminar "{{name}}"?',
    confirmDeleteMessage: 'El campo desaparecerá de todos los formularios de bobina.',
    confirmDeleteMessageInUse: 'El campo se usa en {{count}} bobina(s). Esos valores también se eliminarán.',
    editAria: 'Editar {{name}}',
    deleteAria: 'Eliminar {{name}}',
    removeOptionAria: 'Quitar {{option}}',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Bobinas de filamento, historial de uso, control de costes, ubicaciones de almacenamiento y campos personalizados',
