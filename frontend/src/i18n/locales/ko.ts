export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: '장치의 웹 인터페이스 열기',
      webInterfaceMixedContent: '포함할 수 없습니다 — Bambuddy는 HTTPS로 실행되지만 장치는 일반 HTTP만 제공합니다. 새 탭에서 여세요.',
      webInterfaceHint: '비어 있거나 작동하지 않나요? 장치가 포함을 차단할 수 있습니다.',
      firmware: '펌웨어',
      lastSeen: '마지막 확인',
  ...
  locations: {
    ...
    search: '보관 위치 검색...',
    noSearchResults: '검색과 일치하는 보관 위치가 없습니다.',
    manage: '위치',
    ...
    clearRfid: 'RFID 태그 지우기',
    rfidCleared: 'RFID 태그를 지웠습니다',
    tagClearFailed: '태그를 지우지 못했습니다',
  ...
  customFields: {
    title: '사용자 정의 필드',
    subtitle: '직접 만든 필드를 정의해 모든 스풀에서 사용하세요',
    manage: '사용자 정의 필드',
    add: '필드 추가',
    edit: '필드 편집',
    name: '이름',
    namePlaceholder: '예: 고객, 배치',
    key: '키',
    keyPlaceholder: '예: customer',
    keyHint: 'API와 Spoolman에서 쓰는 식별자입니다. 이름에서 채워지며 라틴 문자, 숫자, 밑줄만 가능합니다.',
    keyLocked: '필드를 만들면 키는 고정됩니다.',
    type: '유형',
    typeHint: '각 스풀에서 값을 입력하는 방식을 정합니다.',
    typeLocked: '이 필드에 값이 있는 스풀이 있는 동안에는 유형을 바꿀 수 없습니다.',
    clear: '지우기',
    rangeMin: '최소',
    rangeMax: '최대',
    rangeMaxAria: '{{name}} 최대값',
    types: {
      text: '텍스트',
      integer: '정수',
      integer_range: '정수 범위',
    ...
    options: '옵션',
    optionPlaceholder: '옵션을 입력하고 Enter',
    optionsRequired: '옵션을 하나 이상 추가하세요',
    optionDuplicate: '이미 있는 옵션입니다',
    nameRequired: '필드 이름은 필수입니다',
    spools: '스풀',
    empty: '사용자 정의 필드가 없습니다. 하나 만들어 스풀에 원하는 데이터를 추가하세요.',
    noValue: '값 없음',
    staleOption: '{{value}} (삭제됨)',
    created: '필드를 만들었습니다',
    updated: '필드를 업데이트했습니다',
    deleted: '필드를 삭제했습니다',
    saveFailed: '필드를 저장하지 못했습니다',
    deleteFailed: '필드를 삭제하지 못했습니다',
    confirmDelete: '"{{name}}"을(를) 삭제할까요?',
    confirmDeleteMessage: '이 필드는 모든 스풀 양식에서 사라집니다.',
    confirmDeleteMessageInUse: '이 필드는 스풀 {{count}}개에서 사용 중입니다. 해당 값도 함께 삭제됩니다.',
    editAria: '{{name}} 편집',
    deleteAria: '{{name}} 삭제',
    removeOptionAria: '{{option}} 제거',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: '필라멘트 스풀, 사용 이력, 비용 추적, 보관 위치, 사용자 정의 필드',
