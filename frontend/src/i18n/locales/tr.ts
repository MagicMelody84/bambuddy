export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      ipAddress: 'IP adresi',
      webInterface: 'Web arayüzü',
      openWebInterface: 'Cihazın web arayüzünü aç',
      webInterfaceMixedContent: 'Gömülemiyor — Bambuddy HTTPS üzerinden çalışıyor, cihaz yalnızca düz HTTP sunuyor. Yeni sekmede açın.',
      webInterfaceHint: 'Boş mu veya çalışmıyor mu? Cihaz gömmeyi engelliyor olabilir.',
      firmware: 'Firmware',
  ...
  // Kullanıcı tanımlı makara alanları
  customFields: {
    title: 'Özel alanlar',
    subtitle: 'Kendi alanlarınızı tanımlayın ve her makarada kullanın',
    manage: 'Özel alanlar',
    add: 'Alan ekle',
    edit: 'Alanı düzenle',
    name: 'Ad',
    namePlaceholder: 'örn. Müşteri, Parti',
    key: 'Anahtar',
    keyPlaceholder: 'örn. musteri',
    keyHint: 'API ve Spoolman için tanımlayıcı. Addan doldurulur; yalnızca latin harfleri, rakamlar ve alt çizgi.',
    keyLocked: 'Alan oluşturulduktan sonra anahtar sabittir.',
    type: 'Tür',
    typeHint: 'Değerin her makarada nasıl girileceğini belirler.',
    typeLocked: 'Bu alanda değeri olan makaralar varken tür değiştirilemez.',
    clear: 'Temizle',
    rangeMin: 'En az',
    rangeMax: 'En çok',
    rangeMaxAria: '{{name}} en çok',
    types: {
      text: 'Metin',
      integer: 'Tam sayı',
      integer_range: 'Tam sayı aralığı',
      float: 'Ondalık',
      float_range: 'Ondalık aralık',
      datetime: 'Tarih ve saat',
      boolean: 'Evet / Hayır',
      choice: 'Seçim listesi',
    },
    options: 'Seçenekler',
    optionPlaceholder: 'Bir seçenek yazıp Enter’a basın',
    optionsRequired: 'En az bir seçenek ekleyin',
    optionDuplicate: 'Bu seçenek zaten var',
    nameRequired: 'Alan adı gerekli',
    spools: 'Makaralar',
    empty: 'Henüz özel alan yok. Makaralara kendi verilerinizi eklemek için bir alan oluşturun.',
    noValue: 'Değer yok',
    staleOption: '{{value}} (kaldırıldı)',
    created: 'Alan oluşturuldu',
    updated: 'Alan güncellendi',
    deleted: 'Alan silindi',
    saveFailed: 'Alan kaydedilemedi',
    deleteFailed: 'Alan silinemedi',
    confirmDelete: '"{{name}}" silinsin mi?',
    confirmDeleteMessage: 'Alan tüm makara formlarından kaldırılacak.',
    confirmDeleteMessageInUse: 'Alan {{count}} makarada kullanılıyor. Bu değerler de silinecek.',
    editAria: '{{name}} düzenle',
    deleteAria: '{{name}} sil',
    removeOptionAria: '{{option}} kaldır',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Filament makaraları, kullanım geçmişi, maliyet takibi, depolama konumları ve özel alanlar',
