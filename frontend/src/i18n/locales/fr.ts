export default {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      openWebInterface: 'Ouvrir l’interface web de l’appareil',
      webInterfaceMixedContent: 'Intégration impossible — Bambuddy fonctionne en HTTPS et l’appareil ne sert que du HTTP. Ouvrez-le dans un nouvel onglet.',
      webInterfaceHint: 'Page blanche ou inactive ? L’appareil bloque peut-être l’intégration.',
      firmware: 'Micrologiciel',
  ...
  locations: {
    ...
    clearRfid: 'Effacer l’étiquette RFID',
    rfidCleared: 'Étiquette RFID effacée',
    tagClearFailed: 'Échec de l’effacement de l’étiquette',
  ...
  // Champs de bobine définis par l'utilisateur
  customFields: {
    title: 'Champs personnalisés',
    subtitle: 'Définissez vos propres champs et utilisez-les sur chaque bobine',
    manage: 'Champs personnalisés',
    add: 'Ajouter un champ',
    edit: 'Modifier le champ',
    name: 'Nom',
    namePlaceholder: 'ex. Client, Lot',
    key: 'Clé',
    keyPlaceholder: 'ex. client',
    keyHint: 'Identifiant pour l’API et Spoolman. Repris du nom ; uniquement lettres latines, chiffres et tirets bas.',
    keyLocked: 'La clé est figée dès que le champ existe.',
    type: 'Type',
    typeHint: 'Détermine comment la valeur est saisie sur chaque bobine.',
    typeLocked: 'Le type est verrouillé tant que des bobines portent une valeur pour ce champ.',
    clear: 'Vider',
    rangeMin: 'Min.',
    rangeMax: 'Max.',
    rangeMaxAria: 'Maximum de {{name}}',
    types: {
      text: 'Texte',
      integer: 'Entier',
      integer_range: 'Plage d’entiers',
      float: 'Décimal',
      float_range: 'Plage décimale',
      datetime: 'Date et heure',
      boolean: 'Oui / Non',
      choice: 'Liste de choix',
    },
    options: 'Options',
    optionPlaceholder: 'Saisissez une option puis Entrée',
    optionsRequired: 'Ajoutez au moins une option',
    optionDuplicate: 'Cette option existe déjà',
    nameRequired: 'Le nom du champ est obligatoire',
    spools: 'Bobines',
    empty: 'Aucun champ personnalisé. Créez-en un pour ajouter vos propres données aux bobines.',
    noValue: 'Aucune valeur',
    staleOption: '{{value}} (supprimée)',
    created: 'Champ créé',
    updated: 'Champ mis à jour',
    deleted: 'Champ supprimé',
    saveFailed: 'Échec de l’enregistrement du champ',
    deleteFailed: 'Échec de la suppression du champ',
    confirmDelete: 'Supprimer « {{name}} » ?',
    confirmDeleteMessage: 'Le champ disparaîtra de tous les formulaires de bobine.',
    confirmDeleteMessageInUse: 'Le champ est utilisé sur {{count}} bobine(s). Ces valeurs seront également supprimées.',
    editAria: 'Modifier {{name}}',
    deleteAria: 'Supprimer {{name}}',
    removeOptionAria: 'Retirer {{option}}',
  },
  ...
  backup: {
    ...
    spoolInventoryDescription: 'Bobines de filament, historique d’utilisation, suivi des coûts, emplacements de stockage et champs personnalisés',
