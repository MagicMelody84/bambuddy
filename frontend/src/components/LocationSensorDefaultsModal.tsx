...
import { Battery, Droplets, Save, Settings2, Thermometer, X } from 'lucide-react';
...
export function LocationSensorDefaultsModal({ onClose }: Props) {
  const { t } = useTranslation();
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-bambu-dark-tertiary">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-white">{t('locationHaSensors.defaults.title')}</h2>
          </div>
